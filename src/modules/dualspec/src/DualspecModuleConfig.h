...
namespace cmangos_module
{
    ...
    // Renumbered from upstream flekz 100601 (too close to vanilla NPC range)
    // to 190024, slotting after the other Emberstone vendor NPCs.
    #define DUALSPEC_NPC_ENTRY 190024
